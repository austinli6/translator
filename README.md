...
Lightweight Design: No external libraries or dependencies required.

How It Works

HTML Structure:

Contains a dropdown (<select>) for language selection.

A content area (<div>) to display the translated text.

JavaScript Logic:

An object stores translations for each supported language.

The change event listener on the dropdown detects when a user selects a language.

The corresponding translation is displayed in the content area.

CSS Styling:

Minimal styles for a clean and centered layout.
